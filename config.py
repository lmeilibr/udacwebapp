...
class Config(object):
    ...
    SQL_SERVER = os.environ.get('SQL_SERVER') or 'db.database.windows.net'
    ...
    AUTHORITY = "https://login.microsoftonline.com/059890b0-09ae-4a9a-b4b9-3c1633e55027"

    CLIENT_ID = os.getenv("CLIENT_ID")

    REDIRECT_PATH = "https://udacproj1.azurewebsites.net/getAToken"  # Used to form an absolute URL; must match to app's redirect_uri set in AAD
